...
<body>
  ...
  <script>
 d3.json('flat_ai_canon.json', data => {
    ...
    selection.each(function scope() {
      ...
      function update(clickedNode) {
        ...
        var channelsGrandchildren = enteredNodes
          .append("circle")
          .attr('r', attrs.nodeSize)
          .attr('stroke-width', attrs.nodeStrokeWidth)
        ...
        nodes
          .attr('fill', d => {
            return d._children ? attrs.collapsedParentColor : d.children ? attrs.parentColor : attrs.leafColor;
          })
